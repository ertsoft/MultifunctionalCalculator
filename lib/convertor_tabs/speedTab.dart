...
class SpeedConvertor extends StatefulWidget {
  @override
  _SpeedConvertorState createState() => _SpeedConvertorState();
}

class _SpeedConvertorState extends State<SpeedConvertor> {
  final fromController = TextEditingController();

  var _speedItems = [
    'metrii pe secundă (m/s)',
    'metrii pe oră (m/h)',
    'kilometrii pe secundă (Km/s)',
    'kilometrii pe oră (km/h)',
